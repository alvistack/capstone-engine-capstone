...
Requires: libcapstone4 = %{epoch}:%{version}-%{release}
...
%post -n libcapstone4 -p /sbin/ldconfig
%postun -n libcapstone4 -p /sbin/ldconfig

%files
%license LICENSE.TXT
%{_bindir}/*

%files -n libcapstone4
%{_libdir}/*.so.*
